...
exports.coin = {
  // name: Display name of the cryptocurrency coin being explored. This value is shown in page titles, headers, and labels.
  //       NOTE: This is a UI/display value and can differ from the database key.
  "name": "Exor",
  // dbname: MongoDB coin key used for coinstats/richlist/heavy queries.
  //         If omitted, the explorer automatically falls back to "coin.name" for backward compatibility.
  "dbname": "Exor",
  ...
  "symbol": "EXOR",
  // decimals: Number of decimal places for displayed price/balance/value fields.
  //           Valid values: -1 (legacy behavior), 0-8 (fixed display precision), values > 8 are clamped to 8.
  "decimals": -1
};
...
// blockchain_dashboard: a collection of settings that pertain to the blockchain dashboard page
exports.blockchain_dashboard = {
  // enabled: Enable/disable the dashboard page (true/false)
  //          If set to false, the dashboard page will be completely inaccessible
  "enabled": true,
  // page_header: a collection of settings that pertain to the blockchain dashboard page header
  "page_header": {
    // show_last_updated: Determine whether to show a label below the page title with the last updated date (true/false)
    "show_last_updated": true
  },
  // top_panels: a collection of settings that control the visibility of the four panels at the top of the dashboard
  "top_panels": {
    // show_latest_block: Show/hide the Latest Block panel displaying the current block height and hash (true/false)
    "show_latest_block": true,
    // show_difficulty: Show/hide the Difficulty panel displaying the current network difficulty (true/false)
    "show_difficulty": true,
    // show_total_supply: Show/hide the Total Supply panel displaying the current total coin supply (true/false)
    "show_total_supply": true,
    // show_total_transactions: Show/hide the Total Transactions panel displaying the total number of transactions (true/false)
    "show_total_transactions": true
  },
  // rolling_averages: a collection of settings that control the rolling averages section
  "rolling_averages": {
    // enabled: Show/hide the entire rolling averages section (true/false)
    "enabled": true,
    // metrics: a collection of settings that control which metrics are displayed in the rolling averages
    "metrics": {
      // show_block_interval: Show/hide the average block interval (true/false)
      "show_block_interval": true,
      // show_avg_tx_count: Show/hide the average transaction count per block (true/false)
      "show_avg_tx_count": true,
      // show_avg_tx_value: Show/hide the average transaction value (true/false)
      "show_avg_tx_value": true,
      // show_avg_tx_fees: Show/hide the average transaction fees (true/false)
      "show_avg_tx_fees": true,
      // show_sum_tx_count: Show/hide the sum of all transactions (true/false)
      "show_sum_tx_count": true,
      // show_sum_tx_value: Show/hide the sum of all transaction values (true/false)
      "show_sum_tx_value": true,
      // show_sum_tx_fees: Show/hide the sum of all transaction fees (true/false)
      "show_sum_tx_fees": true
    }
  },
  // time_filters: An array of numbers representing the time filter options in days. Use -1 to represent "All Time"
  //               For example: [7, 30, 90, 180, 365, -1] will create buttons for "7 Days", "30 Days", "90 Days", "180 Days", "365 Days", and "All Time"
  //               The labels will always display the number followed by "Days" (e.g., "365 Days") except for -1 which displays "All Time"
  "time_filters": [7, 30, 90, 180, 365, -1],
  // charts: a collection of settings that control the visibility of each chart on the dashboard
  "charts": {
    // show_tx_count: Show/hide the Daily Transaction Count chart (true/false)
    "show_tx_count": true,
    // show_tx_value: Show/hide the Daily Transaction Value chart (true/false)
    "show_tx_value": true,
    // show_block_rewards: Show/hide the Daily Block Rewards chart (true/false)
    "show_block_rewards": true,
    // show_fees: Show/hide the Daily Fees chart (true/false)
    "show_fees": true,
    // show_blocks: Show/hide the Daily Blocks chart (true/false)
    "show_blocks": true,
    // show_block_time: Show/hide the Daily Average Block Time chart (true/false)
...
exports.markets_page = {
  ...
  //            Supported exchanges: altmarkets, dex-trade, dexomy, exbitron, freiexchange/freixlite, nestex, nonkyc, poloniex, rabid_rabbit, xeggex, yobit
  "exchanges": {
    ...
    "altmarkets": {
      ...
      // priority: Control the order in which this exchange appears in the menu (lower numbers appear first)
    ...
    // exbitron: a collection of settings that pertain to the exbitron exchange
    "exbitron": {
      // enabled: Enable/disable the exbitron exchange (true/false)
      //          If set to false, the exbitron page will be completely inaccessible and no market data will be downloaded for this exchange
      "enabled": false,
      // trading_pairs: An array of market trading pair symbols
      //                You can add as many trading pairs as necessary
      //                All entries must specify your coins symbol as it is displayed on the exchange, followed by a slash (/) and ending with the symbol of the market or asset that is being traded against
    ...
    // nestex: a collection of settings that pertain to the nestex exchange
    "nestex": {
      // enabled: Enable/disable the nestex exchange (true/false)
      //          If set to false, the nestex page will be completely inaccessible and no market data will be downloaded for this exchange
      "enabled": false,
      // trading_pairs: An array of market trading pair symbols
      //                You can add as many trading pairs as necessary
      //                All entries must specify your coins symbol as it is displayed on the exchange, followed by a slash (/) and ending with the symbol of the market or asset that is being traded against
    ...
    // rabid_rabbit: a collection of settings that pertain to the rabid_rabbit exchange
    "rabid_rabbit": {
      // enabled: Enable/disable the rabid_rabbit exchange (true/false)
      //          If set to false, the rabid_rabbit page will be completely inaccessible and no market data will be downloaded for this exchange
      "enabled": false,
      // trading_pairs: An array of market trading pair symbols
      //                You can add as many trading pairs as necessary
      //                All entries must specify your coins symbol as it is displayed on the exchange, followed by a slash (/) and ending with the symbol of the market or asset that is being traded against
      //                Ex: "LTC/BTC", "LTC/USDT", "LTC/ETH"
      "trading_pairs": [ "RIN/USDT" ],
      // priority: Control the order in which this exchange appears in the menu (lower numbers appear first)
      //           If not specified, defaults to 999
      "priority": 999
    },
...
exports.api_page = {
  ...
  "public_apis": {
    ...
    "ext": {
      ...
      // getlastorphans: a collection of settings that pertain to the /ext/getlastorphans api endpoint
      //                 Returns orphaned blocks with reorg depth greater than a specific value, starting from a particular offset
      //                 NOTE: This api is not used internally and is therefore only publicly available
      "getlastorphans": {
        // enabled: Enable/disable the /ext/getlastorphans api endpoint (true/false)
        //          If set to false, the /ext/getlastorphans api will be completely disabled for public use (no definition on the api page and a disabled error msg if you try to call the endpoint directly)
        "enabled": true,
        // max_items_per_query: The maximum # of orphaned blocks that can be returned from the /ext/getlastorphans api endpoint in a single call
        "max_items_per_query": 100
      },
...
exports.orphans_page = {
  ...
  // reorg_warning_depth: Reorg depth at which to show a warning (orange) badge next to block heights
  //                      Set to 0 to disable warning badges
  "reorg_warning_depth": 2,
  // reorg_critical_depth: Reorg depth at which to show a critical (red) badge next to block heights
  //                       Set to 0 to disable critical badges
  "reorg_critical_depth": 6
};
...
exports.sync = {
  ...
  "check_timeout": 250,
  // checkpoint_tx_interval: Build a history checkpoint every N transactions during checkpoint sync (/path/to/node scripts/sync.js checkpoint [tx_interval])
  //                         A lower value builds more checkpoints (faster historical queries, more storage), while a higher value builds fewer checkpoints (less storage, larger replay window)
  "checkpoint_tx_interval": 50000,
...
// zmq_listener: a collection of settings that pertain to the ZMQ block-notification listener daemon (scripts/zmq_listener.js)
//               The listener subscribes to the coin daemon's ZMQ publisher and triggers an incremental block sync
//               each time a new block is confirmed, replacing the need for a frequent cron-based sync job.
//               See docs/ZMQ_LISTENER.md for full setup instructions.
exports.zmq_listener = {
  // enabled: Enable/disable the ZMQ listener feature (true/false)
  //          When set to false the listener process will exit immediately on startup
  //          NOTE: The daemon itself must still be started separately (e.g. via systemd); this flag is a safety switch
  "enabled": false,
  // endpoint: The tcp:// endpoint published by the coin daemon
  //           Must match the zmqpubhashblock (or zmqpubrawblock) value in rincoin.conf
  "endpoint": "tcp://127.0.0.1:28332",
  // topics: Array of ZMQ topics to subscribe to
  //         Only "hashblock" is needed for block sync triggering; "hashtx" is not used by default
  //         Valid options: "hashblock", "hashtx", "rawblock", "rawtx", "sequence"
  "topics": ["hashblock"],
  // debounce_seconds: Seconds to wait after the last ZMQ notification before triggering a sync cycle
  //                   Coalesces rapid notifications (e.g. during reorgs) into a single sync run
  //                   Lower values = faster reaction to new blocks; higher values = fewer sync invocations
  "debounce_seconds": 5,
  // sync_cooldown_seconds: Minimum seconds between consecutive sync cycle starts
  //                        Set to 0 to disable (recommended when using ZMQ; the debounce already coalesces bursts)
  //                        Set to 30 or higher only for non-ZMQ installs that run sync from cron
  "sync_cooldown_seconds": 0,
  // max_triggers_per_minute: Hard cap on the number of sync cycles that can start in any 60-second window
  //                          Acts as a circuit-breaker if the coin daemon sends unexpected bursts
  "max_triggers_per_minute": 10,
  // run_dashboard_update: Whether to also run scripts/update_dashboard.js after each sync cycle (true/false)
  //                       Set to false if the dashboard is disabled or managed by a separate cron job
...
exports.loadSettings = function loadSettings() {
  ...
  if (json_settings != null) {
    ...
    json_settings = fix_deprecated_setting(json_settings, 'public_api.ext.getlastorphans', 'api_page.public_apis.ext.getlastorphans.enabled');
    ...
    // sanitize coin display decimals setting
    if (exports.coin == null)
      exports.coin = {};

    if (exports.coin.decimals == null || isNaN(exports.coin.decimals))
      exports.coin.decimals = -1;
    else {
      const parsedDecimals = parseInt(exports.coin.decimals);

      if (isNaN(parsedDecimals) || parsedDecimals < 0)
        exports.coin.decimals = -1;
      else if (parsedDecimals > 8)
        exports.coin.decimals = 8;
      else
        exports.coin.decimals = parsedDecimals;
    }
  }
};
